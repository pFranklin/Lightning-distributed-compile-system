...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk ../../../../Bin/win32/test.exe

../../../../Bin/win32/test.exe: ${OBJECTFILES}
	${MKDIR} -p ../../../../Bin/win32
	${LINK.cc} -o ../../../../Bin/win32/test -s ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/825861859/main.o: ../../../../src/test/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/825861859
	${RM} $@.d
	$(COMPILE.cc) -O3 -Wall -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/825861859/main.o ../../../../src/test/main.cpp
