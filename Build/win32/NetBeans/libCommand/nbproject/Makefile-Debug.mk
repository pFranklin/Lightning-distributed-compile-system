...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Debug.mk ../../../../Bin/win32/plugins/libCommand.dll

../../../../Bin/win32/plugins/libCommand.dll: ${OBJECTFILES}
	${MKDIR} -p ../../../../Bin/win32/plugins
	${LINK.cc} -shared -o ../../../../Bin/win32/plugins/libCommand.dll ${OBJECTFILES} ${LDLIBSOPTIONS} 

${OBJECTDIR}/_ext/1756224175/cCommandFactory.o: ../../../../src/libCommand/cCommandFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1756224175
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I../../../../Contrib/boost_include  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1756224175/cCommandFactory.o ../../../../src/libCommand/cCommandFactory.cpp

${OBJECTDIR}/_ext/1756224175/cCommand_nv_cg.o: ../../../../src/libCommand/cCommand_nv_cg.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1756224175
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I../../../../Contrib/boost_include  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1756224175/cCommand_nv_cg.o ../../../../src/libCommand/cCommand_nv_cg.cpp

${OBJECTDIR}/_ext/1756224175/cCommand.o: ../../../../src/libCommand/cCommand.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1756224175
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -I../../../../Contrib/boost_include  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1756224175/cCommand.o ../../../../src/libCommand/cCommand.cpp
